...
export const MonteCarloSimulation: React.FC = () => {
  ...
  const chartData = result
    ? result.percentiles.p10.map((_, index) => ({
        year: index + 1,
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setParams({
                    ...params,
                    initialWealth: Number(e.target.value),
                  })
                }
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setParams({ ...params, volatility: Number(e.target.value) })
                }
              />
            </div>
            <div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setParams({ ...params, simulations: Number(e.target.value) })
                }
              />
            </div>
          </div>
          <Button onClick={runSimulation} disabled={isRunning} className="mt-4">
            {isRunning ? (
              <>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">
                    {formatCurrency(
                      result.percentiles.p50[result.percentiles.p50.length - 1],
                    )}
                  </div>
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600">
                    {formatCurrency(
                      result.percentiles.p90[result.percentiles.p90.length - 1],
                    )}
                  </div>
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-600">
                    {formatCurrency(
                      result.percentiles.p10[result.percentiles.p10.length - 1],
                    )}
                  </div>
